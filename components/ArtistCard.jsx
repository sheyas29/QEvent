...
const ArtistCard = ({ artistData }) => {
  ...
  return (
    <div className="hover-inverse group w-[20%] min-w-[300px] h-fit flex flex-col items-center text-center justify-center transform transition-transform duration-400 hover:scale-110 hover:bg-gradient-to-r hover:from-orange-200 hover:to-white text-dark m-4 border-slate-400 border rounded-md px-8 py-2.5">
      <div>
        <img
        ...
        <h3 className="text-2xl my-3">{artistData.artist}</h3>
